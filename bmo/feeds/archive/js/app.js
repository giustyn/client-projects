$(function () {
  ...
  function weatherHandler(data) {
    ...
    const setCurrent = () => {
      ...
      $(".current .temperature").text(current.CurrentTempF + "°");
  ...
  function animateCurrentWeather() {
    const container = $(".container")[0],
      current = container.querySelectorAll(".current"),
      forecast = container.querySelectorAll(".forecast");
  ...
  function animate() {
    ...
    let animation = anime
      ...
      .add({
        targets: container.querySelectorAll("#news *"),
      ...
      .add(
        {
          begin: () => animateCurrentWeather(),
          targets: container.querySelectorAll(
            "#weather .heading, #weather .current *"
          ),
          delay: anime.stagger(animeDelay),
          endDelay: 5000,
          translateY: ["10%", "0%"],
      ...
      .add(
        {
          begin: () => animateWeatherForecast(),
          targets: container.querySelectorAll("#weather .forecast *"),
          delay: anime.stagger(animeDelay),
          translateY: ["10%", "0%"],
          opacity: [0, 1],
        },
